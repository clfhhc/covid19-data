...
var connectDb = function connectDb(_ref) {
  var _ref$name, name, _ref$entities, entities, _ref$shouldDrop, shouldDrop, connection;

  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function connectDb$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _ref$name = _ref.name, name = _ref$name === void 0 ? defaultConnectionName : _ref$name, _ref$entities = _ref.entities, entities = _ref$entities === void 0 ? defaultEntities : _ref$entities, _ref$shouldDrop = _ref.shouldDrop, shouldDrop = _ref$shouldDrop === void 0 ? false : _ref$shouldDrop;
          _context.prev = 1;
        ...
        case 8:
          ...
          _context.next = 12;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(typeorm_browser__WEBPACK_IMPORTED_MODULE_1__["getConnectionManager"])().create({
            type: 'sqljs',
            sqlJsConfig: {
...
//# sourceMappingURL=index.js.e2d1d894bd22af5255da.hot-update.js.map